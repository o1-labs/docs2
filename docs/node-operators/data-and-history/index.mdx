...
Mina is a succinct blockchain, and as a result, consensus nodes only store the recent history of the chain before discarding it (the last k blocks, currently 290). Recent history can be accessed via graphQL from a running `mina daemon`.
