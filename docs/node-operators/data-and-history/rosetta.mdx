...
2. Use the official image `minaprotocol/mina-rosetta:3.0.2-4aac388-focal-mainnet`, which is built in exactly this way by buildkite CI/CD.
...
To run docker-start.sh and connect to the live Mainnet:
    ...
    docker run -it --rm --name rosetta \
        ...
        minaprotocol/mina-rosetta:3.0.2-4aac388-focal-mainnet
