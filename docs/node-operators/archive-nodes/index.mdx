...
This section describes how to run an Archive node in the Mina protocol.

- [Getting Started](archive-nodes/getting-started) - How to get started running an Arhive node.
- [Archive Redundancy](archive-nodes/archive-redundancy) - Discusses minimize the risk of archive data loss.
