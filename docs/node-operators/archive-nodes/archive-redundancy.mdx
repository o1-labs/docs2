...
Set the transaction level after you create the [database](/node-operators/archive-nodes/archive-node) and before you connect an archive process to it.
