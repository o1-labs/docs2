...
Now you can follow the instructions on the <DocLink copy="Connecting to the Network" url="/node-operators/connecting" /> to install the latest version of the daemon.
