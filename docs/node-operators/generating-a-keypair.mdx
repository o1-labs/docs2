...
To use Mina on Mainnet or to fully participate in a Mina test network, the first step is to generate a key pair that consists of a public key and a private key. 

In some cases, you want to generate more than one key pair. For example, to run a block producer most securely, you need accounts on both hot and cold wallets. See [Hot and Cold Block Production](/node-operators/hot-cold-block-production).
...
### Installation on Ubuntu 18.04 and Debian 9
