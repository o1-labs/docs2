...
A zkApp can retrieve events and actions from one or more Mina archive nodes. If your smart contract needs to fetch events and actions from an archive node, see [How to Fetch Events and Actions](../../zkapps/o1js/writing-a-zkapp/feature-overview/fetch-events-and-actions).
