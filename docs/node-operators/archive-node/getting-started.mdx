...
1. Install the archive node package.
   ...
   - Ubuntu/Debian:
     ...
     ```
     sudo apt-get install mina-archive=3.0.2-4aac388
     ```

   - Docker:

     ```
     minaprotocol/mina-archive:3.0.2-4aac388-bullseye
     ```
...
2. Pull the archive node image from Docker Hub.
   ...
   ```sh
   docker pull minaprotocol/mina-archive:3.0.2-4aac388-bullseye
   ```
