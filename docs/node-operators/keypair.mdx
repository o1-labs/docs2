...
See our [client SDK documentation](/node-operators/keypair#client-sdk) for more information.
...
Now that we have created our keypair, we can finally [connect to the network](/node-operators/connecting) or share your public key.
