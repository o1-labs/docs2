...
2. Mina Foundation, Account B, payout should be: (0.6 x 0.92) x 720 MINA x 3 blocks = 1,192.32 MINA. 
3. Account A retains 8%, (0.6 x 0.08) x 720 MINA x 3 blocks = 103.68 MINA. 
3. Account C payout should be: (0.2 x 0.92) x 720 MINA x 3 blocks = 397.44 MINA. 
