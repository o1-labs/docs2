...
For reference, this explanation describes how reward returns are calculated. The mandatory script manages returns to both the MinaFoundation Address and Burn Address.
