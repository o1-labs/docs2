...
See [this answer](./troubleshooting#can-i-send-a-payment-before-i-am-synced), you will need to wait until you are synced if you do not have an existing balance in the ledger.
...
See [this answer](./troubleshooting#how-can-i-increase-my-chance-of-winning-a-block).
