...
- Run as a systemd service (see [the docs](connecting#ubuntu-1804--debian-9-1)).
- Run with Docker (see [the docs](connecting#docker)).
...
The methods to start a node [in the documentation](connecting) will run a block producer by default.
