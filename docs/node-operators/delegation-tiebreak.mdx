...
hide_title: true
description: How to confirm the random tiebreak result.
keywords:
  - delegation program
  - tie break system
  - tie break system
  - delegation cycle
  - delegation program uptime tracker
  - tie break process
---
...
1. Block producer keys that straddle the 240th place in the uptime snapshot are determined eligible to receive a [Mina Foundation Delegation Policy](https://minaprotocol.com/blog/mina-foundation-delegation-policy).
...
1. Identify the VRF seed from the last epoch of the previous cycle.
    ...
    - To obtain the VRF seed by yourself, you can query the [https://graphql.minaexplorer.com/](https://graphql.minaexplorer.com) using the last epoch of the previous cycle with:
