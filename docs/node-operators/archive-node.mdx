...
See the [fetching events](../zkapps/advanced-snarkyjs/events#fetching-events-from-an-archive-node) and [fetching actions](../zkapps/advanced-snarkyjs/actions-and-reducer#fetching-actions-from-an-archive-node) sections in the SnarkyJS documentation to see how you can use the archive node in your zkApps.
