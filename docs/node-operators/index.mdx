...
2. [SNARK Coordinators](https://docs.minaprotocol.com/glossary#snark-coordinator) - Distributes work to a series of SNARK workers in parallel to block production.
...
4. [Archive Nodes](https://docs.minaprotocol.com/node-operators/archive-node) - Mina daemon configured to send blockchain data to a [PostgreSQL](https://www.postgresql.org/) database.
