...
Install the latest **Stable** [Mina Release 3.0.2](https://github.com/MinaProtocol/mina/releases/tag/3.0.2) or visit the [GitHub Releases Page](https://github.com/MinaProtocol/mina/releases) to install pre-release (Alpha/Beta) builds.
...
docker run --name mina -d \
       ...
       gcr.io/o1labs-192920/mina-daemon:3.0.2-4aac388-bullseye-devnet \
       daemon
```
