...
To install the latest [Mainnet **Stable** Release 3.0.2](https://github.com/MinaProtocol/mina/releases/tag/3.0.2), use the installation steps for your environment. Supported environments include macOS, Linux (Debian 10, 11 and Ubuntu 20.04 LTS), and any host machine with Docker.
...
The expected output is `Commit 4aac38814556b9641ffbdfaef19b38ab7980011b`.
