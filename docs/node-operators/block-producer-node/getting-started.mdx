...
To install the latest [Mainnet Stable Stop Slot Release 2.0.0](https://github.com/MinaProtocol/mina/releases/tag/2.0.0), use the installation steps for your environment. Supported environments include macOS, Linux (Debian 10, 11 and Ubuntu 20.04 LTS), and any host machine with Docker.
