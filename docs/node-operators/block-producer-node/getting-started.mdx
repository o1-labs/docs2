...
This documentation is for the **Mainnet** release. The releases can be found [here.](https://github.com/MinaProtocol/mina/releases)
...
- 8-core processor
- 16 GB of RAM
- 20 GB of free storage (at least)

**Network**: At least 1 Mbps connection

## Snark Work Requirements
