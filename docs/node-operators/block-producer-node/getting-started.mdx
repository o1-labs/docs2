...
Get started setting up a Mina node, learn how to generate a keypair for use with the network [here](/node-operators/generating-a-keypair), and install the `mina daemon`.

This documentation is for the **Mainnet** release. The releases can be found [here](https://github.com/MinaProtocol/mina/releases), check this page for version specific flags.
...
- 8-core processor
- 32 GB of RAM
- 64 GB of free storage (at least)
...
To install the latest [Mainnet **Stable** Release 1.4.0](https://github.com/MinaProtocol/mina/releases/tag/1.4.0), use the installation steps for your environment. Supported environments include macOS, Linux (Debian 10, 11 and Ubuntu 20.04 LTS), and any host machine with Docker.
