...
To install the latest [Mainnet **Stable** Release 3.0.2](https://github.com/MinaProtocol/mina/releases/tag/3.0.2), use the [Installation](/node-operators/block-producer-node/getting-started#installation) steps for your environment.
