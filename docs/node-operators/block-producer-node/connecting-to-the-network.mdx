---
title: Connect to the Mina Network
hide_title: true
...
To install the latest [Mainnet **Stable** Release 1.4.0](https://github.com/MinaProtocol/mina/releases/tag/1.4.0), use the [Installation](/node-operators/block-producer-node/getting-started#installation) steps for your environment.
...
To earn MINA tokens, check out the [Mina Foundation Delegation Program](/node-operators/foundation-delegation-program).
