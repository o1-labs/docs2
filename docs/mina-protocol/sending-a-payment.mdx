...
Transactions signed with the Mina Signer can use: [https://minaexplorer.com/broadcast-tx](https://minaexplorer.com/broadcast-tx)
...
We are assuming in the rest of section that you have the Mina client installed on your system, if you do not have Mina installed please see the [Getting Started](/node-operators/getting-started).
