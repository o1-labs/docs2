...
title: Scan State
hide_title: true
description: The scan state is a data structure that allows decoupling the production of transaction SNARKs from block producers to snark workers. Here we explain how it works.
keywords:
  - data structure
  - blockchian
  - full binary tree
