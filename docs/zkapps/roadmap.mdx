...
- [How to Fetch Events and Actions](/zkapps/advanced-snarkyjs/fetch-events-and-actions)
...
- [Using on-chain values](/zkapps/advanced-snarkyjs/on-chain-values) — a.k.a. protocol and account preconditions
