...
For a real-world example of using Lightnet accounts, see [run_live.ts](https://github.com/o1-labs/o1js/blob/main/src/examples/zkapps/hello-world/run-live.ts) example file used in [Tutorial 1: Hello World](/zkapps/tutorials/hello-world).
