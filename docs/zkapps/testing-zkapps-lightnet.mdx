...
Now that you have Lightnet running, you can run a single command to configure your zkApp:
...
To monitor transactions and visualize the network, launch the lightweight Mina Explorer:
