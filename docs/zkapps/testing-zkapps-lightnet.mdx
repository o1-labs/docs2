...
You can add contributions, create feature requests, and create issues for Lightnet in the https://github.com/o1-labs/zkapp-cli repository. Be sure to add the `lightnet` label. 