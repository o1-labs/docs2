...
A Docker image for Mina local networks provides a simple and efficient way to deploy and run a lightweight Mina blockchain network for testing zkApps. See [Testing zkApps with Lightnet](/zkapps/testing-zkapps-lightnet).
