...
const transactionLink = `https://minascan.io/devnet/tx/${hash}`;
        ...
        switch (e.message) {
          case  e.message.includes("Cannot read properties of undefined (reading 'requestAccounts')"):
            console.error("Is Auro installed?");
            break;
          case  e.message.includes("Please create or restore wallet first."):
            console.error("Have you created a wallet?");
            break;
          case  e.message.includes("User rejected the request."):
