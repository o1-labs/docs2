...
- Commands to launch a single node or multi node network

Use the zk lightnet start command to pull the [o1labs/mina-local-network](https://hub.docker.com/r/o1labs/mina-local-network) image from Docker Hub.
