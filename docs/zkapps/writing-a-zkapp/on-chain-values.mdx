...
In a zkApp, you can access the current [on-chain state](/zkapps/writing-a-zkapp/how-to-write-a-zkapp#on-chain-state) and many other on-chain values of the account.
