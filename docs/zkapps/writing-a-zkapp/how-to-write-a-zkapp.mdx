...
1. Select an accompanying UI framework, if any:
  ...
  > next
    ...
    For your selected UI framework, follow the prompts. See [How to Write a zkApp UI](/zkapps/writing-a-zkapp/how-to-write-a-zkapp-ui).
...
- [Basic concepts](zkapps/writing-a-circuit/basic-concepts)
- [Interacting with Mina](zkapps/writing-a-zkapp/interact-with-mina)
...
Now that you've learned how to write and operate a basic smart contract, you can learn about [Testing zkApps Locally](/zkapps/writing-a-zkapp/testing-zkapps-locally).
