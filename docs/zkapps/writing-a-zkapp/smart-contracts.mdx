...
One workaround is to use actions. See [Actions and Reducer](/zkapps/writing-a-zkapp/actions-and-reducer).
...
Smart contract method arguments can be any of the built-in [o1js types](/zkapps/writing-a-circuit/basic-concepts#built-in-data-types).
