...
1. [Write tests for your smart contract](/zkapps/writing-a-zkapp/testing-zkapps-locally#writing-tests-for-your-smart-contract) and test locally on a simulated local blockchain
