...
Next, go further with [Tutorial 1: Hello World](https://docs.minaprotocol.com/zkapps/tutorials/hello-world) and dive into the [How to Write a zkApp](how-to-write-a-zkapp) page to learn more.
...
To learn more, read about [how zkApps work](how-zkapps-work), [how to write a zkApp](zkapps/how-to-write-a-zkapp), and [zkApps for Ethereum Developers](./zkapps/zkapps-for-ethereum-developers).
