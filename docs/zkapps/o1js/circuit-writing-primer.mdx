...
You see, `Provable.constraintSystem` lets us visualize our entire circuit.  When using `Provable.constrainSystem`, witnesses need to be explicitly created for any input data.  This is easily verified by updating the code:
