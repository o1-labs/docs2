...
You see, `Provable.constraintSystem` let's us visualize our entire circuit.  When using `Provable.constraintSystem`, witnesses need to be explicitly created for any input data.  This is easily verified by updating the code:
