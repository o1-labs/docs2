...
To use actions, you must first declare their type on the smart contract. The object to declare is called a **reducer** -- because it can take a list of actions and reduce them:
