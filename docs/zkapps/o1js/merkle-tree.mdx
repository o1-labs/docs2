...
The `examples` folder in the o1js repository includes a working [Merkle tree](https://github.com/o1-labs/o1js/tree/main/src/examples/zkapps/merkle_tree) example with all of the required boilerplate code.
...
You can look at the [Merkle tree example](https://github.com/o1-labs/o1js/tree/main/src/examples/zkapps/merkle_tree) in the o1js repository to get a better understanding of how you can leverage the power of Merkle trees.

:::info

Merkle trees are great for _referencing_ off-chain state. But more than referencing the state is required - you must also store it somewhere.

Where and how to store the data off-chain storage is left up to you, the developer. Tell us how are using Merkle trees in the  [#zkapps-developers](https://discord.com/channels/484437221055922177/915745847692636181) channel in Mina Protocol Discord.
