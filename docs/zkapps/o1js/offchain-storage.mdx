...
Furthermore, the smart contract requires a field indicating the commitment to the offchain state. This field allows accessing offchain state similar to any other on-chain value.
...
Additionally, developers need to set the smart contract instance and assign it to the offchain storage.
