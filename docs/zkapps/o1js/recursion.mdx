...
Kimchi, the proof system that backs o1js, supports arbitrary infinite recursive proof construction of circuits through integration with the Pickles recursive system. 
...
:::note
zkProgram is available as a top-level import directly. `Experimental.ZkProgram` is deprecated.

If you are experiencing issues with zkProgram, be sure to update [o1js](https://github.com/o1-labs/o1js) to the latest version.
:::
