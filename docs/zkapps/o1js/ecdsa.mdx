...
ECDSA works with different elliptic curves but most commonly with the [secp256k1](/glossary#secp256k1) curve. This curve is also used in Bitcoin and Ethereum.
...
Most usages require you to verify a hash of a message instead of the message itself. In Ethereum, for example, the message is the [Keccak](keccak) hash of the transaction data.
