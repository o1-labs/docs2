...
So, when you choose what hash function to use, an important consideration is the use case and the data that needs to be hashed.
...
See the o1js repository for a [hashing example](https://github.com/o1-labs/o1js/tree/main/src/examples/zkapps/hashing) of how to use Keccak. 
