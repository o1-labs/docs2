...
<!-- notes from a convo with Jack
Code runs in JS
In order to prove that code is correctly, it is passed into a circuit to verify proofs

We built gates that part of the circuit

Gadgets are bigger parts of the circuit and are made out of gates
-->
