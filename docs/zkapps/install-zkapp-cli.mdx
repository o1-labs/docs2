...
:::tip
To build zero knowledge apps that use [o1js](/zkapps/o1js), you only need to install the zkApp CLI. o1js is automatically included when you create a project using the zkApp CLI. In your project directory, use `zk system` to show the system information with installed versions of zkApp CLI and o1js.
:::
