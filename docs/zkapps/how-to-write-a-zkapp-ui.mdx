...
1. After you make changes to your project files, you must build your project so that the changes are reflected in the smart contract consumed by your UI project:
