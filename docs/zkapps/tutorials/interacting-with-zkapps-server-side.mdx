...
This tutorial shows how to do this. This can be useful when initializing a zkApp using programmatically generated information, deploying a zkApp in custom ways, or writing scripts that create transactions depending on real world events or on-chain events.
...
Once you've created your project, and deployed it, we can write a script to interact with our smart contract. 
