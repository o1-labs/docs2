...
We will be using a set of helper functions to make this more convenient to write, in a `utils.ts` file. You can find this file [here](https://github.com/o1-labs/docs2/blob/main/docs/zkapps/examples/interacting-with-zkApps-server-side/src/utils.ts). Please download this and place it in your project's `src` folder. It contains 3 functions:
...
Open up `main.ts` in a text editor. You can find the complete source for this [here](https://github.com/o1-labs/docs2/blob/main/docs/zkapps/examples/interacting-with-zkApps-server-side/src/main.ts).
...
Note as we deployed our smart contract already with `zk deploy`, programmatic deploy is not needed, and is commented out here. If you would like to see how this works, or its useful for your application, see code for this [here](https://github.com/o1-labs/docs2/blob/main/docs/zkapps/examples/interacting-with-zkApps-server-side/src/deploy.ts).
