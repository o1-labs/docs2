...
This tutorial has been verified with [Mina zkApp CLI](https://github.com/o1-labs/zkapp-cli) version `0.13.0` and [o1js](https://www.npmjs.com/package/o1js) `0.12.1`.
