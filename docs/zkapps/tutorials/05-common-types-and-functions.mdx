...
<<<<<<< HEAD
This tutorial has been tested with [zkApp CLI](https://github.com/o1-labs/zkapp-cli) version `0.20.1` and [o1js](https://www.npmjs.com/package/o1js) version `1.1.0`.
=======
This tutorial has been tested with [zkApp CLI](https://www.npmjs.com/package/zkapp-cli) version `0.16.0` and [o1js](https://www.npmjs.com/package/o1js) version `0.15.2`.
>>>>>>> main
