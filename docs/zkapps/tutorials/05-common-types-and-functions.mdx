...
Fields in private key: 255 // bit field element of the scalar field of the curve
Fields in public key: 2 // (x,y) coordiante
signature verified for data1: false
signature verified for data2: true
Fields in signature: 256 // bit field scalar nonce + a field element
```
