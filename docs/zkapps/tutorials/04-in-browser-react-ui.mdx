...
If you would like to try out the application before going through the tutorial (recommended), you can do so [here](TODO).

Unlike previous tutorials, we will not be going over all of the code for this example. You can find the full source code [here](TODO). Instead we will talk through key parts of the application. Much of the code can be reused when you write your own application; we will focus on explaining the parts most different from the CLI tutorial, and the parts you may want to modify if you use this as a starter for your own application.
...
We will be reusing the smart contract from the [previous tutorial](TODO), particularly, the project `03-deploying-to-a-live-network`
...
```sh
$ npm link 03-deploying-to-a-live-network
```
...
You can see the full code [here](TODO).
...
We won't be going through this file here, but you can see it [here](TODO). It styles our page.

### utils.jsx

We won't be going through this file here, but you can see it [here](TODO). It provides some convenience functions for the heavily sequential and asynchronous operations we perform setting up our application and sending transactions.
