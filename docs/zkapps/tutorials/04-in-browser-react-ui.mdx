...
This is to match our export of snarkyjs in `04-zkapp-browser-ui-smart-contract` we did earlier. As mentioned, this is necessary to avoid duplicate instances of snarkyjs, but will be fixed in a future iteration.
