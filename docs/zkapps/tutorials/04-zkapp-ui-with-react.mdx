...
- [zkApp CLI](https://www.npmjs.com/package/zkapp-cli) version `0.20.0`
...
- In `04-zkapp-browser-ui/ui/src/pages/zkappWorker.ts`
  ...
  Depending on the network you are going to work with you might want to consider changing the GraphQL endpoint in the `setActiveInstanceToBerkeley` function.  
