...
1. Move the files to your local `04-zkapp-browser-ui/ui/app/pages` directory.
...
1. Move the `index.page.tsx` file to your local `04-zkapp-browser-ui/ui/app` directory.
...
These `04-zkapp-browser-ui/ui/app/page.tsx` statement creates mutable state that you can reference in the UI. The state updates as the application runs:
