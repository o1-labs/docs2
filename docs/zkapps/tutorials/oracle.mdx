...
You can view the complete oracle code [here](https://github.com/jackryanservia/credit-score-signer-vercel/blob/main/pages/api/credit-score/%5Bid%5D.ts) and can generate a Mina-compatible public/private key pair for your oracle using [this script](fixme).
