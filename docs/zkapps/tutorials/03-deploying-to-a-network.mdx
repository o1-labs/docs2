...
Copy in `src/Square.ts` and `src/index.ts` from the first tutorial - you can find these [here](https://github.com/o1-labs/docs2/tree/main/docs/zkapps/examples/01-hello-world/src).
