...
1. Now, create a new file for your smart contract:
  ...
  The command also generates the `Square.test.ts` test file. 
...
You already installed the zkApp CLI as part of the [Prerequisites](/zkapps/tutorials#prerequisites), so you have the tools to manage deployments.
