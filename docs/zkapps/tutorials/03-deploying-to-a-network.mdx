...
In this tutorial, you use the `zk config` command to create a deploy alias, request MINA funds to pay for transaction fees, and deploy a project to a live network.
