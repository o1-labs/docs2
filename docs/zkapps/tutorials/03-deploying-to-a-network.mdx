...
In this tutorial, you will use the `zk config` command to create the deploy alias, request MINA funds to pay for transaction fees, and deploy zkApp to a live network.
