...
Each zkApp transaction constructed by o1js is composed of one or more [AccountUpdates](../snarkyjs-reference/classes/AccountUpdate), which are a set of instructions for the Mina network to perform, such as altering on-chain state, emitting an event, etc.
...
- [Permissions](../o1js/permissions)
- [Preconditions](../o1js/on-chain-values)

## AccountUpdate contents

Each [AccountUpdate](../o1js-reference/classes/AccountUpdate) has these components:
