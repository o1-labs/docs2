...
You can find all of the code for this tutorial [here on github](https://github.com/o1-labs/docs2/tree/main/examples/zkapps/10-account-updates).
...
Last, to look briefly at [SecondaryZkApp.ts](https://github.com/o1-labs/docs2/tree/main/examples/zkapps/10-account-updates/src/SecondaryZkApp.ts), we have contents:
...
We'll now discuss the file [main.ts](https://github.com/o1-labs/docs2/tree/main/examples/zkapps/10-account-updates/src/main.ts), which creates transactions with the above smart contracts, and the account update visualizations it creates.
