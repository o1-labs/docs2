...
- [Permissions](/zkapps/writing-a-zkapp/permissions)
- [On-Chain Values](/zkapps/writing-a-zkapp/on-chain-values)
...
- `Authorization`: How the zkApp is authorized; must be a proof (corresponding to the verification key on the account), a signature, or none. See [Authorizations](/zkapps/writing-a-zkapp/interact-with-mina#authorizations).
