...
In this tutorial, we will review smart contract code that creates and manages new tokens. You can find the full code of what we'll be building in this tutorial [here](https://github.com/o1-labs/docs2/tree/main/docs/zkapps/examples/08-custom-tokens/src).
...
You can find a full copy of this file [here](https://github.com/o1-labs/docs2/blob/main/docs/zkapps/examples/08-custom-tokens/src/BasicTokenContract.ts).
...
And, to see an example of putting rules around a token, see this example of a token with a whitelist gating which public keys can interact with it [here](https://github.com/o1-labs/docs2/blob/main/docs/zkapps/examples/08-custom-tokens/src/WhitelistedTokenContract.ts).
...
Check out out our other tutorials and documentation to learn more about SnarkyJS and zkApps!
