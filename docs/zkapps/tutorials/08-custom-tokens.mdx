...
You can also find a more extensive example, including all the ways to interact with token smart contracts, [here](https://github.com/o1-labs/o1js/blob/main/src/lib/token.test.ts) for reference.
...
This will come in a future part of this tutorial. For now, see this example [here](https://github.com/o1-labs/o1js/blob/main/src/examples/zkapps/dex/dex.ts) of a zkApp implementing an AMM-based DEX.
...
To learn more on tokens, see [the token docs](/zkapps/o1js/custom-tokens).

Checkout [Tutorial 9](recursion) to learn how to use recursive ZKPs with o1js, to implement zkRollups, large computations, and more.
