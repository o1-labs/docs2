...
...
 ...
 35     zkAppInstance.init(Poseidon.hash([ salt, Field.fromNumber(750) ]));
 36     zkAppInstance.sign(zkAppPrivateKey);
 37   });
 ...
```

Note the init function taking a poseidon hash of of the salt and our secret, in this case the number 750.
