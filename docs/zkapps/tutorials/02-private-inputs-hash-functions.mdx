...
This tutorial has been tested with [Mina zkApp CLI](https://github.com/o1-labs/zkapp-cli) version `0.9.0` and [SnarkyJS](https://www.npmjs.com/package/snarkyjs) `0.9.8`.
...
1. Now, create the new files for your project:
  ...
  - The `zk file` command created the `src/IncrementSecret` and `src/Square.test.ts` test files.
