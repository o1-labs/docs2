...
In the [Hello World](hello-world) tutorial, you built a basic zkApp smart contract in SnarkyJS with a single state variable that could be updated if you knew the square of that number.
