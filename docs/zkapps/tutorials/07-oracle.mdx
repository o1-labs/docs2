...
This oracle uses a Koa server hosted on DigitalOcean. It's short, but you don't have to dive into the code now. The code is commented to explain each step so you can use it as a model to build something similar.
