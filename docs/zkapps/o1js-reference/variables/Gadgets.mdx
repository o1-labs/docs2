...
```ts
provable: GenericProvableExtendedPure<[Field, Field, Field], [string, string, string], Field>;
```
...
```ts
divMod32: (n, quotientBits) => object;
```
...
[lib/provable/gadgets/gadgets.ts:36](https://github.com/o1-labs/o1js/blob/ccbd5fd4525adaf6c1f07bef7847d7bac67c71b5/src/lib/provable/gadgets/gadgets.ts#L36)
