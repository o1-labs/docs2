```ts
type PendingTransaction: Pick<Transaction, "transaction" | "toJSON" | "toPretty"> & object;
```
...
[lib/mina/transaction.ts:130](https://github.com/o1-labs/o1js/blob/ccbd5fd4525adaf6c1f07bef7847d7bac67c71b5/src/lib/mina/transaction.ts#L130)
