...
| `permissions` | \{ `access`: [`AuthRequired`](Types.Json.md#authrequired) ; `editActionState`: [`AuthRequired`](Types.Json.md#authrequired) ; `editState`: [`AuthRequired`](Types.Json.md#authrequired) ; `incrementNonce`: [`AuthRequired`](Types.Json.md#authrequired) ; `receive`: [`AuthRequired`](Types.Json.md#authrequired) ; `send`: [`AuthRequired`](Types.Json.md#authrequired) ; `setDelegate`: [`AuthRequired`](Types.Json.md#authrequired) ; `setPermissions`: [`AuthRequired`](Types.Json.md#authrequired) ; `setTiming`: [`AuthRequired`](Types.Json.md#authrequired) ; `setTokenSymbol`: [`AuthRequired`](Types.Json.md#authrequired) ; `setVerificationKey`: \{ `auth`: [`AuthRequired`](Types.Json.md#authrequired) ; `txnVersion`: [`UInt32`](Types.Json.md#uint32)  } ; `setVotingFor`: [`AuthRequired`](Types.Json.md#authrequired) ; `setZkappUri`: [`AuthRequired`](Types.Json.md#authrequired)  } |
...
| `permissions.setVerificationKey` | \{ `auth`: [`AuthRequired`](Types.Json.md#authrequired) ; `txnVersion`: [`UInt32`](Types.Json.md#uint32)  } |
| `permissions.setVerificationKey.auth` | [`AuthRequired`](Types.Json.md#authrequired) |
| `permissions.setVerificationKey.txnVersion` | [`UInt32`](Types.Json.md#uint32) |
...
| `body.update.permissions` | \{ `access`: [`AuthRequired`](Types.Json.md#authrequired) ; `editActionState`: [`AuthRequired`](Types.Json.md#authrequired) ; `editState`: [`AuthRequired`](Types.Json.md#authrequired) ; `incrementNonce`: [`AuthRequired`](Types.Json.md#authrequired) ; `receive`: [`AuthRequired`](Types.Json.md#authrequired) ; `send`: [`AuthRequired`](Types.Json.md#authrequired) ; `setDelegate`: [`AuthRequired`](Types.Json.md#authrequired) ; `setPermissions`: [`AuthRequired`](Types.Json.md#authrequired) ; `setTiming`: [`AuthRequired`](Types.Json.md#authrequired) ; `setTokenSymbol`: [`AuthRequired`](Types.Json.md#authrequired) ; `setVerificationKey`: \{ `auth`: [`AuthRequired`](Types.Json.md#authrequired) ; `txnVersion`: [`UInt32`](Types.Json.md#uint32)  } ; `setVotingFor`: [`AuthRequired`](Types.Json.md#authrequired) ; `setZkappUri`: [`AuthRequired`](Types.Json.md#authrequired)  } \| ``null`` |
