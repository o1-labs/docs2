...
1. [Test with a lightnet](#6-test-with-a-lightnet)
...
### 6. Test with a lightnet

To test your zkApp locally on a lightnet that is an accurate representation of Mina blockchain:
...
1. Start a local blockchain:
    ...
    Use the start configuration options appropriate for your use case. See [Start a local network with other settings](/zkapps/lightnet#start-a-local-network-with-other-settings).
...
1. Configure your zkApp for the lightnet blockchain. Use the helpful URLs from the lightnet status.     
    ...
    (how do we want to do the account step? needs revamp)

1. Deploy your zkApp to the lightnet blockchain:
