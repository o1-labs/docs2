...
`LocalBlockchain` code in the [Add.test.ts](https://github.com/o1-labs/zkapp-cli/blob/main/templates/project-ts/src/Add.test.ts#L27-L28) example file.
...
1. Deploy the smart contract to the `LocalBlockchain` instance.
...
- Instead of using Jest, create a Node.js script to run the smart contract and test it's functionality, similar to step [4. Add testing code](#4-add-testing-code).
    ...
    See the example Node.js script that runs the Add smart contract in the [run.ts](https://github.com/o1-labs/zkapp-cli/blob/main/examples/tictactoe/ts/src/run.ts) file. 
