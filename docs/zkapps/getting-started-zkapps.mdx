...
1. Run your script.
    ...
    ```
Note : This command runs the interact.js script with the argument "berkeley." If you have set up a different alias name, replace "berkeley" with your actual alias name.
