...
Now that you've learned how to deploy a smart contract, you can now learn [how to write a UI for your zkApp](/zkapps/writing-a-zkapp/introduction-to-zkapps/how-to-write-a-zkapp-ui).
