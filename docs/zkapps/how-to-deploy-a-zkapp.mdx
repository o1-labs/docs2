...
(add a statement that these steps are for Mainnet and Berkeley)
...
following command: (will be different steps)

```sh
zk config
```

When prompted, specify a name (can be anything), URL to deploy to, fee (in
