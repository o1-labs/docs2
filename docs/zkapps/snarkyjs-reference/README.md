...
[lib/zkapp.ts:1232](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/zkapp.ts#L1232)
...
[lib/circuit_value.ts:440](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/circuit_value.ts#L440)
...
[lib/zkapp.ts:1038](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/zkapp.ts#L1038)

[lib/zkapp.ts:1386](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/zkapp.ts#L1386)
...
[lib/state.ts:25](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/state.ts#L25)

[lib/state.ts:18](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/state.ts#L18)
...
[lib/account_update.ts:1671](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/account_update.ts#L1671)

[lib/account_update.ts:1672](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/account_update.ts#L1672)
...
[lib/account_update.ts:161](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/account_update.ts#L161)

[lib/account_update.ts:225](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/account_update.ts#L225)
...
[lib/hash.ts:36](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/hash.ts#L36)
...
[snarky.d.ts:1174](https://github.com/o1-labs/snarkyjs/blob/531db43/src/snarky.d.ts#L1174)
...
[lib/zkapp.ts:1289](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/zkapp.ts#L1289)
...
[lib/merkle_tree.ts:215](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/merkle_tree.ts#L215)
...
[lib/circuit_value.ts:680](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/circuit_value.ts#L680)
...
[lib/fetch.ts:358](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/fetch.ts#L358)
...
[lib/circuit_value.ts:317](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/circuit_value.ts#L317)
...
[lib/circuit_value.ts:390](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/circuit_value.ts#L390)
...
[lib/zkapp.ts:1366](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/zkapp.ts#L1366)
...
[lib/state.ts:115](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/state.ts#L115)

___

### deploy

▸ **deploy**<`S`\>(`SmartContract`, `«destructured»`): `Promise`<`string`\>
...
| `SmartContract` | `S` |
| `«destructured»` | `Object` |
| › `feePayer?` | [`FeePayerSpec`](modules/Mina.md#feepayerspec) |
| › `initialBalance?` | `string` \| `number` |
| › `tokenId?` | [`Field`](classes/Field.md) |
| › `verificationKey` | `Object` |
| › `verificationKey.data` | `string` |
| › `verificationKey.hash` | `string` \| [`Field`](classes/Field.md) |
| › `zkappKey` | [`PrivateKey`](classes/PrivateKey.md) |
...
[lib/zkapp.ts:1241](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/zkapp.ts#L1241)
...
[lib/fetch.ts:47](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/fetch.ts#L47)
...
[lib/fetch.ts:384](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/fetch.ts#L384)
...
[snarky/addons.js:18](https://github.com/o1-labs/snarkyjs/blob/531db43/src/snarky/addons.js#L18)
...
[lib/circuit_value.ts:326](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/circuit_value.ts#L326)
...
[lib/zkapp.ts:93](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/zkapp.ts#L93)
...
[lib/circuit_value.ts:251](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/circuit_value.ts#L251)
...
[lib/circuit_value.ts:443](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/circuit_value.ts#L443)
...
[lib/circuit_value.ts:602](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/circuit_value.ts#L602)
...
[lib/circuit_value.ts:342](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/circuit_value.ts#L342)
...
[snarky/addons.js:49](https://github.com/o1-labs/snarkyjs/blob/531db43/src/snarky/addons.js#L49)
...
[lib/fetch.ts:528](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/fetch.ts#L528)
...
[snarky/addons.js:27](https://github.com/o1-labs/snarkyjs/blob/531db43/src/snarky/addons.js#L27)
...
[lib/fetch.ts:30](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/fetch.ts#L30)
...
[snarky.d.ts:1169](https://github.com/o1-labs/snarkyjs/blob/531db43/src/snarky.d.ts#L1169)
...
[lib/zkapp.ts:1323](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/zkapp.ts#L1323)
...
[lib/state.ts:39](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/state.ts#L39)
...
[lib/proof_system.ts:112](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/proof_system.ts#L112)

___

### zkappCommandToJson

▸ **zkappCommandToJson**(`«destructured»`): [`ZkappCommand`](modules/Types.Json.md#zkappcommand)

#### Parameters

| Name | Type |
| :------ | :------ |
| `«destructured»` | `ZkappCommand` |
...
[lib/account_update.ts:1558](https://github.com/o1-labs/snarkyjs/blob/531db43/src/lib/account_update.ts#L1558)
