...
Mina zkApp CLI makes it easy to follow recommended best practices by providing project scaffolding including dependencies such as SnarkyJS, a test framework [Jest](https://jestjs.io/), code auto-formatting [Prettier](https://prettier.io/
...
- Linux (apt, yum, and others)
  ...
  As recommended by the NodeJS Project, you might need to install a recent NodeJS version using NodeSource: [Debian](https://github.com/nodesource/distributions#debinstall), [rpm](https://github.com/nodesource/distributions#rpminstall).
...
Examples are provided in the [zkapp-cli
/examples/
](https://github.com/o1-labs/zkapp-cli/tree/main/) folder.
...
4. Fund your fee payer account.

  Follow the prompts to request tMina. 

5. Deploy to Testnet: `zk deploy`
...
If you haven't yet read [how zkApps work](how-zkapps-work) pages, please read it now to build your foundational knowledge.
