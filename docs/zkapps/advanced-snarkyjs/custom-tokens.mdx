...
For a more comprehensive example of how to use custom tokens with a zkApp, see this custom token example provided in [token.test.tx]](https://github.com/o1-labs/snarkyjs/blob/main/src/lib/token.test.ts).
