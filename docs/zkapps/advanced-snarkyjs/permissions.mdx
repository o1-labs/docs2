...
Consider the UnsecureContract smart contract example provided in the [simple_zkapp_payment.ts](https://github.com/o1-labs/snarkyjs/blob/main/src/examples/zkapps/simple_zkapp_payment.ts) in the `snarkyjs` codebase repo:
