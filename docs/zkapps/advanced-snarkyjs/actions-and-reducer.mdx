...
=======
If your smart contract needs to fetch actions from an archive node, see [How to Fetch Events and Actions](fetch-events-and-actions).

> > > > > > > new how to fetch events and actions
