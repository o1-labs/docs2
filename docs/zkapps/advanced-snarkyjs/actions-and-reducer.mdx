...
To see a end-to-end example of zkApp fetching actions from a running network and including them into your zkApp, [see this voting example that gets recently emitted actions](https://github.com/o1-labs/snarkyjs/blob/main/src/examples/zkapps/voting/voting.ts).
