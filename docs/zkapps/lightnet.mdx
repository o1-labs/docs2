...
This command performs the following operations using default settings that successfully serve the majority of testing requirements:
...
<!-- 
Question for Serhii: how to release accounts? 
-->
