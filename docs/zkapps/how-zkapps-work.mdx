...
zkApps run in the latest versions of [Chrome](https://www.google.com/chrome/index.html, [Firefox](https://www.mozilla.org/en-US/firefox/new/), [Edge](microsoft.com/edge), and [Brave](https://brave.com/ web browsers.
