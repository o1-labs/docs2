...
- Run the latest Mina Node version. *The latest Mina Node version will be shared on [Discord](https://discord.com/channels/484437221055922177/1093199272423473222), before the protocol performance testing starts.*
...
- The release notes with the latest software baseline and the configuration instructions will be provided to Block Producers in the dedicated [Discord](https://discord.com/channels/484437221055922177/1093199272423473222) channel before the start of the program.
...
#### Update process
- The Block Producer will get a notification in advance in the dedicated [Discord](https://discord.com/channels/484437221055922177/1093199272423473222) channel when a new version of the Mina Node will be available. Release Notes will be provided with any addiitonal configuration instructions.
...
- The Load Tester will get a notification 24 hours in advance in the dedicated [Discord](https://discord.com/channels/484437221055922177/1093199272423473222) channel.
...
- The Load Tester runs the extra nodes in the same way as during the baseline load testing (same configuration, uptime, SW baseline, etc.) but without running consensus (block production is not needed.)

#### Configuration setup
- The release notes with the latest software baseline and the configuration instructions will be provided to Load Testers in the dedicated [Discord](https://discord.com/channels/484437221055922177/1093199272423473222) channel before the start of the program
...
- The Load Tester spins down the 10 load testing nodes when asked to in this [Discord](https://discord.com/channels/484437221055922177/1093199272423473222) channel.
...
#### Update process
- The Load Tester will get a notification in advance in the dedicated [Discord](https://discord.com/channels/484437221055922177/1093199272423473222) channel when a new version of the Mina Node will be available. Release Notes will be provided with any addiitonal configuration instructions. 
...
- The release notes with the latest software baseline and the configuration instructions will be provided to Snarkworker Operator in the dedicated [Discord](https://discord.com/channels/484437221055922177/1093199272423473222) channel before the start of the program.
...
#### Update process
- The SNARK worker operator will get a notification in advance in the dedicated [Discord](https://discord.com/channels/484437221055922177/1093199272423473222) channel when a new version of the Mina Node will be available. Release Notes will be provided with any addiitonal configuration instructions.
...
#### High level responsibilities
- Run the latest Mina node and Archive Processor, with associated PostgreSQL database. *The latest Archive Node version will be shared on [Discord](https://discord.com/channels/484437221055922177/1093199272423473222), before the protocol performance testing starts.*
...
#### Update process
- The Archive Node operator will get a notification in advance in the dedicated [Discord](https://discord.com/channels/484437221055922177/1093199272423473222) channel when a new version of the Archive Node will be available. Release Notes will be provided with any addiitonal configuration instructions. 
