...
1. Install a Chrome zkApp-compatible [Mina wallet](../install-a-wallet).
...
4. In your Mina browser wallet extension, confirm the transaction again.
5. Done! Congratulations. Your transaction is processed by the Mina network  and the zkApp state is updated.
