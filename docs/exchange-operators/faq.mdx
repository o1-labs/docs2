...
The table here describes how many blocks you will need to wait: [Lifecycle Payment](../node-operators/lifecycle-of-a-payment)
...
See our [instructions for connecting to DevNet](connecting-to-devnet).
