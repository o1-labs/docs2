...
The table in [Lifecycle Payment](../node-operators/lifecycle-of-a-payment) describes how many blocks you wait for a transaction to be confirmed.
...
Staking incurs a delay between 18 to 29 days before you start receiving rewards.
