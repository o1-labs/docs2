...
If you want to run Mina Rosetta on the Apple Silicon, please follow steps described in [Building and running Rosetta from source code](build-from-sources) page
