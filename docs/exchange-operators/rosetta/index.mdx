...
[Rosetta API](https://docs.cloud.coinbase.com/rosetta/docs/welcome) is an open-source specification and set of tools that make deploying and interacting with the blockchain quickly and easily.
