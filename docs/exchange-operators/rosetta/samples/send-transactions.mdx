...
1. Given a keypair, derive the account indentifier using `/construction/derive` endpoint
...
For ease of readability, our sample implementation skips sanity checks (steps 4 and 7).
We have also combined steps 2 and 3 in a single `tx_payloads` function call.

Before running this sample:
- Make sure you followed [Offline signer tool](using-signer) article and generated a keypair
