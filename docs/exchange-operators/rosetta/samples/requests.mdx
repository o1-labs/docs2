...
In Mina, each operation represents an [Account Update](/zkapps/writing-a-zkapp/interact-with-mina#account-updates). Therefore, a MINA token transfer transaction is represented by three Account Updates:
