...
```sh
apt install lsb-release sudo postgresql curl wget gpg # debian:11 is surprisingly light
...
sudo apt-get install --allow-downgrades -y mina-archive-migration=3.0.0-rc1-4277e73
