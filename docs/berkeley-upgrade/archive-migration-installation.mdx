---
title: Install the archive migration package
sidebar_label: Install archive migration package
hide_title: false
...
We strongly encourage you to perform the migration on your own data to preserve the idea of decentralization. However, if you want to use the archive data that o1labs runs (for example, to bootstrap a new archive from SQL without waiting all day for the chain to download and replay), you can use the following steps:
