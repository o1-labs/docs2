...
As mentioned in [Planning the Archive Migration](/berkeley-upgrade/planning-archive-migration), the devent/mainnet migration can take up to a couple of days. 
...
However, if you want ot perform them manually please follow below checklist:
...
#### Receipt chain hashes mismatch between Devnet/Mainnet and Berkeley schemas
