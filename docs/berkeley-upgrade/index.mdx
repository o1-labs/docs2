...
There is no need to preserve orginal devnet/mainnet database after migration. However, if for some reason you would like to keep mainnet orphaned or non-canonical pending blocks, it is recommended to download maintenance package for devnet/mainnet database.
