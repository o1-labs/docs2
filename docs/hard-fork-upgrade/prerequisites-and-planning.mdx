...
Mainnet database requires to be migrated in two steps. Each step has responsible application .
These applications are shipped by Mina Foundation and o1 Labs team:
...
You are now ready to perform migration. Please proceed to article:
