...
o1Labs, a Mina ecosystem partner, created and runs the zkApps Builders Program (ZBP), a 12-week online program to support developers who are interested in building zkApps-related projects.

The goal of the program is to provide direct access to the o1Labs team to support developers as they build their zkApp project and to gather feedback for improving [o1js](/zkapps/o1js-reference) and [zkApps](/zkapps). You can read more about the projects that came out of [ZBP cohort 1 (Spring 2022)](https://minaprotocol.com/blog/zkapps-builders-program-spring-2022-wrapup).
...
Learn more about the [Mina Foundation Delegation Program](/node-operators/delegation-program/foundation-delegation-program).
