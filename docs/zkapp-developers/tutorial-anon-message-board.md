...
<!--
One of the benefits of writing smart contracts in TypeScript, is that the compiled JavaScript and WASM smart contract is easy to <DocLink copy="integrate into your website UI" url="/zkapps/how-to-write-a-zkapp" />.
