...
You can use the Mina CLI to interact with the sandbox node. The following command opens a shell inside the docker container from where you can issue any of the available [mina commands](/node-operators/cli-reference).
...
- Install the [GUI Wallet](/gui-wallet) app to use a graphical interface to your node. Enter '127.0.0.1' as the host of your node during setup.
