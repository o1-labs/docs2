...
Head over to the [Testnet landing page](https://minaprotocol.com/blog/testnet) to see how to participate in weekly challenges and get on the testnet leaderboard.
