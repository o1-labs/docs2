  ...
  docs: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: 'category',
          label: 'Writing Circuits with o1js',
          items: [
            'zkapps/writing-a-circuit/index',
            'zkapps/writing-a-circuit/basic-concepts',
            'zkapps/writing-a-circuit/recursion',
            'zkapps/writing-a-circuit/gadgets',
            'zkapps/writing-a-circuit/bitwise-operations',
            'zkapps/writing-a-circuit/foreign-fields',
            'zkapps/writing-a-circuit/merkle-tree',
            'zkapps/writing-a-circuit/keccak',
            'zkapps/writing-a-circuit/ecdsa',
            'zkapps/writing-a-circuit/sha256',
          ],
        },
        {
          type: 'category',
          label: 'Writing zkApps with o1js',
          items: [
            'zkapps/writing-a-zkapp/how-zkapps-work',
            'zkapps/writing-a-zkapp/getting-started-zkapps',
            'zkapps/writing-a-zkapp/how-to-write-a-zkapp',
            'zkapps/writing-a-zkapp/testing-zkapps-locally',
            'zkapps/writing-a-zkapp/testing-zkapps-lightnet',
            'zkapps/writing-a-zkapp/how-to-deploy-a-zkapp',
            'zkapps/writing-a-zkapp/how-to-write-a-zkapp-ui',
            'zkapps/writing-a-zkapp/interact-with-mina',
            'zkapps/writing-a-zkapp/smart-contracts',
            'zkapps/writing-a-zkapp/on-chain-values',
            'zkapps/writing-a-zkapp/permissions',
            'zkapps/writing-a-zkapp/events',
            'zkapps/writing-a-zkapp/actions-and-reducer',
            'zkapps/writing-a-zkapp/fetch-events-and-actions',
            'zkapps/writing-a-zkapp/time-locked-accounts',
            'zkapps/writing-a-zkapp/custom-tokens',
          ],
        },
        {
          type: 'category',
